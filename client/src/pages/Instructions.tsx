...
export function Instructions() {
  ...
  return (
    <>
      {
        useMeta({
          title: "Instructions | AutoHotkey Generator",
          description: "Everything you need to know about running and using AutoHotkey",
          canonical: "https://www.autohotkeygenerator.com/instructions",
        })
      }
