...
export function Home() {
  ...
  return (
    <>
      {
        useMeta({
          title: "Home | AutoHotkey Generator",
          description: "Transform your ideas into powerful AutoHotkey scripts using plain English.",
          canonical: "https://www.autohotkeygenerator.com/",
        })
      }
