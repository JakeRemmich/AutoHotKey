...
export function TermsOfService() {
  ...
  return (
    <>
      ...
      {
        useMeta({
          title: "Terms of Service | AutoHotkey Generator",
          description: "Read the terms and conditions for using AutoHotkey Generator.",
          canonical: "https://www.autohotkeygenerator.com/terms-of-service",
        })
      }
