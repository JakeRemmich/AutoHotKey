...
export function PrivacyPolicy() {
  ...
  return (
    <>
      {
        useMeta({
          title: "Privacy Policy | AutoHotkey Generator",
          description: "Learn how AutoHotkey Generator collects, uses, and protects your data.",
          canonical: "https://www.autohotkeygenerator.com/privacy-policy",
        })
      }
